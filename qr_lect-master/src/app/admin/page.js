    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-2 sm:p-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-4 sm:mb-6 flex items-center justify-between flex-wrap gap-2">
          ...
          >
            <svg className="w-4 sm:w-5 h-4 sm:h-5 mr-2 group-hover:-translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex items-center text-slate-600">
            <svg className="w-4 sm:w-5 h-4 sm:h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-slate-700 to-slate-900 px-4 sm:px-8 py-4 sm:py-6">
            <div className="flex items-center justify-center">
              <svg className="w-6 sm:w-8 h-6 sm:h-8 text-white mr-2 sm:mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 flex-1">
                    <h3 className="text-sm font-semibold text-red-800">{cameraError}</h3>
                    <p className="text-xs text-red-700 mt-2">
                      • Asegúrate de dar permiso para usar la cámara<br/>
                      • Si estás en móvil, usa HTTPS o localhost<br/>
                    ...
                    <div className="bg-white rounded-md p-3 sm:p-4 border border-green-100">
                      <div className="space-y-2">
                        <div className="flex items-center">
                          ...
                          <span className="text-xs sm:text-sm text-slate-600">Nombre:</span>
                          <span className="text-xs sm:text-sm font-semibold text-slate-900 ml-2 truncate">{lastScanned.usuario}</span>
                        </div>
                        {lastScanned.correo && (
                          <div className="flex items-center">
                            <svg className="w-4 h-4 text-slate-400 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <span className="text-xs sm:text-sm text-slate-700 ml-2 truncate">{lastScanned.correo}</span>
                          </div>
                        )}
                        <div className="flex items-center">
                          <svg className="w-4 h-4 text-slate-400 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          ...
                          <span className="text-xs sm:text-sm text-slate-700 ml-2">{lastScanned.fecha}</span>
                        </div>
                      </div>
                    </div>
